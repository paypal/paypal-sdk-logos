...
export var GIROPAY_LOGO_COLORS = (_GIROPAY_LOGO_COLORS = {}, _GIROPAY_LOGO_COLORS[LOGO_COLOR.DEFAULT] = {
  primary: "#FFFFFF",
  secondary: "#003A7D",
  tertiary: "#ED1C24",
  quaternary: "#FFFFFF",
  quinary: "#FFFFFF"
}, _GIROPAY_LOGO_COLORS[LOGO_COLOR.WHITE] = {
  primary: "#000000",
  secondary: "#FFFFFF",
  tertiary: "#FFFFFF",
  quaternary: "#000000",
  quinary: "#FFFFFF"
}, _GIROPAY_LOGO_COLORS[LOGO_COLOR.BLACK] = {
  primary: "#FFFFFF",
  secondary: "#003A7D",
  tertiary: "#ED1C24",
  quaternary: "#FFFFFF",
...
export var getGiropaySVG = function getGiropaySVG(_ref) {
  var primary = _ref.primary,
    secondary = _ref.secondary,
    tertiary = _ref.tertiary,
    quaternary = _ref.quaternary,
    quinary = _ref.quinary;
  return node("svg", {
    width: "89",
    height: "40",
    viewBox: "0 0 89 40",
...
export function GiropayLogoExternalImage(_ref2) {
  var _ref2$logoColor = _ref2.logoColor,
    logoColor = _ref2$logoColor === void 0 ? LOGO_COLOR.BLACK : _ref2$logoColor,
    props = _objectWithoutPropertiesLoose(_ref2, _excluded);
  var cdnUrl = getLogoCDNUrl(LOGO.GIROPAY, GIROPAY_LOGO_COLORS, logoColor);
...
export function GiropayLogoInlineSVG(_ref3) {
  var _ref3$logoColor = _ref3.logoColor,
    logoColor = _ref3$logoColor === void 0 ? LOGO_COLOR.BLACK : _ref3$logoColor,
    props = _objectWithoutPropertiesLoose(_ref3, _excluded2);
  var svg = getGiropaySVG(getLogoColors(LOGO.GIROPAY, GIROPAY_LOGO_COLORS, logoColor));
  return node(SVGLogo, _extends({}, props, {
    name: LOGO.GIROPAY,
    logoColor: logoColor,
...
export var GiropayLogo = GiropayLogoInlineSVG;