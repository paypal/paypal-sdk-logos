...
import { getSVGs, SVGLogo } from "../../lib";
...
var svgGetter = function svgGetter(_ref) {
...
export var getIdealSVGs = function getIdealSVGs() {
  return getSVGs(LOGO.IDEAL, svgGetter, LOGO_COLORS);
};
export function IdealLogo(_ref2) {
  ...
  var CDN_URL = "https://www.paypalobjects.com/images/checkout/latinum/Altpay_logo_iDEAL.svg";
  var svg = getIdealSVGs()[logoColor];
