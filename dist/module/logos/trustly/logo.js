...
export var TRUSTLY_LOGO_COLORS = (_TRUSTLY_LOGO_COLORS = {}, _TRUSTLY_LOGO_COLORS[LOGO_COLOR.DEFAULT] = {
  primary: "#0EE06E"
}, _TRUSTLY_LOGO_COLORS[LOGO_COLOR.WHITE] = {
  primary: "#FFFFFF"
}, _TRUSTLY_LOGO_COLORS[LOGO_COLOR.BLACK] = {
  primary: "#000000"
}, _TRUSTLY_LOGO_COLORS);
export var getTrustlySVG = function getTrustlySVG(_ref) {
