...
export function ItauLogo({ logoColor = LOGO_COLOR.DEFAULT, ...props } : { logoColor? : $Values<typeof LOGO_COLOR> }) : ComponentNode<SVGLogoProps> {
    ...
    return (
        <SVGLogo
            ...
            render={ () => {
                return (
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 750 105" >
                        <rect
                            fill="#ff7900" x="452.24" y="19.99" width="55" height="54.14" rx="8.98"
                            transform="translate(2.52 115.09) rotate(-13.72)" />
                        <rect fill="#004995" x="467.2" y="26.15" width="33.66" height="34.11" rx="5.84" />
                        <path
                            fill={ primary }
                        ...
                        <rect fill={ primary } x="258.48" y="43.2" width="8.08" height="34.11" />
                        <path
                            fill={ primary }
                        ...
                        <rect fill="#fff100" x="469.89" y="43.2" width="2.71" height="11.43" />
                        <path
                            fill="#fff100"
