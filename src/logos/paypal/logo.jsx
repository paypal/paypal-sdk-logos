...
export const getRebrandPayPalSVG = ({ primary }: LogoColors): ElementNode => {
  return (
    <svg
      ...
      fill="none"
    >
      <path d="M792.154 19.48V215.571H747.549V19.48H792.154Z" fill={primary} />
      <path
